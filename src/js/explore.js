...
(function () {
    ...
    // Small square cover with a music-note fallback; the <img> reveals on load.
    ...
    /* ---- Chapter 05 — How You Listen (behavior) ---- */
    ...
    /* ---- Chapter 07 — Your Listening Life ---- */
    ...
    function init() {
        ...
        window.addEventListener('rewind:data-updated', fetchListeningLife);
    }
