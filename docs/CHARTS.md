...
4. **Superlative charts** (§3.2): ~~**Obsession of the Day**~~ + ~~**On Repeat**~~ (**built** — the "Superlatives" section, independent year selector), then Biggest Binges / Most Skipped / Never Skipped / Longest–Shortest.
